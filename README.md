...
- [ ] Explain the difference between `Relational Databases` and `SQL`.
      Relational Databases is about the structure in which a database store the information, in this
      case in a tabular form. SQL is the language that allows to perform CRUD operations on the stored data

- [ ] Why do tables need a `primary key`?
      Primary keys are used to enforce data 'uniqueness' in one of the table columns.

- [ ] What is the name given to a table column that references the primary key on another table.
      Foreign Key

- [ ] What do we need in order to have a _many to many_ relationship between two tables.
      A third table which will have a 'one to many' relationship with the other tables.
